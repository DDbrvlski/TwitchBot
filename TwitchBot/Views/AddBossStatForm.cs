...
{
    public partial class AddBossStatForm : Form
    {
        ...
        {
            // Pobierz dane z kontrolek (np. TextBox)
            BossName = BossNameTextBox.Text;
            NumberOfDeaths = int.Parse(NumberOfDeathsTextBox.Text);  // Możesz dodać sprawdzanie błędów, aby uniknąć wyjątków
            Time = BossTimeTextBox.Text;

            // Ustaw wynik okna dialogowego na OK
